...
public class IRR_5_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_irr_5_3);
        ...
        irr_textview_name.setText("Fauna - Aves Autoctones");
    ...
    public void goto_next(View view){
        startActivity(new Intent(this, IRR_5_4.class));
