...
public class IRR_6_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_irr_6_1);
        ...
        irr_textview_name.setText("Flora");
    ...
    public void goto_next(View view){
        startActivity(new Intent(this, IRR_6_2.class));
