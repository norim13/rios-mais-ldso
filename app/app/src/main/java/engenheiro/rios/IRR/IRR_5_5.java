...
public class IRR_5_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_irr_5_5);
        ...
        irr_textview_name.setText("Fauna - Peixes Autoctones");
    ...
    public void goto_next(View view){
        startActivity(new Intent(this, IRR_5_6.class));
